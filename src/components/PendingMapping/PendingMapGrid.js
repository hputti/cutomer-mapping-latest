...
import PendingMapManage  from "./PendingMapManage";
...
/* Grid Data AXIOS call start */
    const gridData = [
        ['WorkFile','101282','MILLER, LAURIE A.', 'ALL SAINTS EYE CENTER', 'There is only one parent named: AR_PARNT_NAME, DELIVERED_PROFIT_HIGHEST_CUST_PARNT_NAME, PRCA_PARNT_NAME.', 'Added','PRatea test CoGroup', 'Pending', 'user1','10/10/2021','user2', '01/22/2022'],
        ['WorkFile','120942','MILLER, LAURIE A.', 'WINN FAMILY MEDICINE', 'There is only one parent named: PRCA_PARNT_NAME, DELIVERED_PROFIT_HIGHEST_CUST_PARNT_NAME, MARKETING_HIGHEST_CUST_PARNT_NAME.','Added', 'PRatea test CoGroup', 'Pending', 'user4','10/11/2021','user2', '01/22/2022'],
        ['WorkFile','3498232','STEVE, JOHN G., MD', 'OLIVER CHIROPRACTIC', 'There is only one parent named: PRCA_PARNT_NAME, DELIVERED_PROFIT_HIGHEST_CUST_PARNT_NAME, MARKETING_HIGHEST_CUST_PARNT_NAME.', 'Added','PRatea test CoGroup', 'Pending', 'user1','10/10/2021','user2', '01/22/2022'],
        ['WorkFile','3498232','STEVE,  DAPHNE,MD', 'FUENTES, MELECIA MD PA', 'There is only one parent named: PRCA_PARNT_NAME, DELIVERED_PROFIT_HIGHEST_CUST_PARNT_NAME, MARKETING_HIGHEST_CUST_PARNT_NAME.','Added', 'PRatea test CoGroup', 'Pending', 'user1','10/10/2021','user5', '01/22/2022'],
        ['Final','3498232','MILLER,  DAPHNE,MD', 'ALL SAINTS EYE CENTER', 'There is only one parent named: PRCA_PARNT_NAME, DELIVERED_PROFIT_HIGHEST_CUST_PARNT_NAME, MARKETING_HIGHEST_CUST_PARNT_NAME.', 'Added','PRatea test CoGroup', 'Pending', 'user6','10/10/2021','user3', '01/22/2022'],
        ['Final','3498232','MILLER  COUNTY NURSING HOME,', 'PORTASCIENCE INC', 'There is only one parent named: PRCA_PARNT_NAME, DELIVERED_PROFIT_HIGHEST_CUST_PARNT_NAME, MARKETING_HIGHEST_CUST_PARNT_NAME.','Added', 'PRatea test CoGroup', 'Pending', 'user1','10/14/2021','user2', '01/22/2022'],
        ['Final','2014114','MILLER, LAURIE A.', 'HOMELINEPREMIER GPO', 'There is only one parent named: PRCA_PARNT_NAME, DELIVERED_PROFIT_HIGHEST_CUST_PARNT_NAME, MARKETING_HIGHEST_CUST_PARNT_NAME.','Added', 'PRatea test CoGroup', 'Pending', 'user1','10/10/2021','user2', '01/22/2022'],
        ['WorkFile','200167','MILLER, LAURIE A.', 'BRINKMAN, TIMOTHY J., MD', 'There is only one parent named: PRCA_PARNT_NAME, DELIVERED_PROFIT_HIGHEST_CUST_PARNT_NAME, MARKETING_HIGHEST_CUST_PARNT_NAME.','Added', 'PRatea test CoGroup', 'Pending', 'user1','10/17/2021','user6', '01/22/2022'],
        ['WorkFile','101282','MILLER COSMETIC SURGERY,', 'MIDWEST SPINE BRAIN INSTITUTE, LLC', 'There is only one parent named: PRCA_PARNT_NAME, DELIVERED_PROFIT_HIGHEST_CUST_PARNT_NAME, MARKETING_HIGHEST_CUST_PARNT_NAME.', 'Added','PRatea test CoGroup', 'Pending', 'user9','10/19/2021','user2', '01/22/2022'],
        ['Final','101282','MILLERS  HEALTHCARE', 'JUNCTION CLINIC', 'There is only one parent named: PRCA_PARNT_NAME, DELIVERED_PROFIT_HIGHEST_CUST_PARNT_NAME, MARKETING_HIGHEST_CUST_PARNT_NAME.','Added', 'PRatea test CoGroup', 'Pending', 'user10','10/10/2021','user5', '01/22/2022'],
        ['WorkFile','5441251','MILLER JAMES A DMD', 'GOMEZ-SEOANE M.D. PC', 'There is only one parent named: PRCA_PARNT_NAME, DELIVERED_PROFIT_HIGHEST_CUST_PARNT_NAME, MARKETING_HIGHEST_CUST_PARNT_NAME.','Added', 'PRatea test CoGroup', 'Pending', 'user1','10/10/2021','user2', '01/22/2022'],
        ['Final','101282','MILLERS  HEALTHCARE', 'UNITED PHYSICIANS', 'There is only one parent named: PRCA_PARNT_NAME, DELIVERED_PROFIT_HIGHEST_CUST_PARNT_NAME, MARKETING_HIGHEST_CUST_PARNT_NAME.', 'Added','PRatea test CoGroup', 'Pending', 'user1','10/10/2021','user2', '01/22/2022'],
        ['WorkFile','101282','MILLER JAMES A DMD', 'HURLEY MEDICAL CENTER', 'There is only one parent named: PRCA_PARNT_NAME, DELIVERED_PROFIT_HIGHEST_CUST_PARNT_NAME, MARKETING_HIGHEST_CUST_PARNT_NAME.', 'Added','PRatea test CoGroup', 'Pending', 'user1','10/10/2021','user2', '01/22/2022'],
        ['WorkFile','101282','MILLER MD RUSSELL, MD', 'MCMANAMAN, CRAIG J DO', 'There is only one parent named: PRCA_PARNT_NAME, DELIVERED_PROFIT_HIGHEST_CUST_PARNT_NAME, MARKETING_HIGHEST_CUST_PARNT_NAME.','Added', 'PRatea test CoGroup', 'Pending', 'user1','10/10/2021','user2', '01/22/2022'],
    ...
    const columns = [
        {
          ...
          options: {
              customBodyRenderLite: (dataIndex) => {
                ...
                //         <PendingActionsIcon color="primary" fontSize="small"  sx={{ fontSize: "16px" }} />
                //      </Tooltip>
                //     );
                //   }
                 if(rowData[0] == "Final"){
          ...
          <Grid container spacing={0.8} >
                ...
                <Grid container spacing={0.2} >
                    <Grid item xs={2} >
                        ...
                        }}><h3>Pending Customer Mapping</h3></Item>
                    </Grid>
                    <Grid item xs={10} >
                        {/* xs=6xs=6xs=6xs=6 */}
                        <Item style={{ float: 'left', fontSize: '0.5rem',
                          borderRadius: "0.5px", background: "#f1F2F4", marginTop: "-12px"}} sx={{background: "#f1F2F4"}}>
                        {/* <FormControl>
                          <FormLabel id="demo-row-radio-buttons-group-label">Pending</FormLabel> 
                        </FormControl> */}
                       ...
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                        ...
                        <Paper component="form" className={classes.root} style={{width:560,height:33,marginTop : 5}}>
                            <InputBase
                                ...
                                placeholder="Search Pending Mapping"
                                inputProps={{ 'aria-label': 'Search Pending Mapping' }}
                                sx={{fontSize : "0.8rem"}}
                                onChange={event=>{                                
                       ...
                       &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                        <FormControl style={{width:225,height:15,marginTop : 5}}>    
            ...
            <Modal
          open={showModal || showAddPending}
          onClose={handleModelClose}
          aria-labelledby="add Mapping"
        >
          <Box sx={model}>
            <Typography id="add Pending Group" variant="h6" component="h4" sx={{fontSize : 14,fontWeight:'bold'}}>
              {showAddPending ? "Edit Pending Customer Mapping" : "Add Pending Customer Mapping"}
            </Typography>
            <Typography sx={{ mt: 2 }}>
               <PendingMapManage rowItem={customerRec} dialogClose={handleModelClose} showAddPending={showAddPending} handleSucessModelClose={handleSucessModelClose}/>
            </Typography>
          </Box>
        </Modal>
...
export default PendingGroupGrid