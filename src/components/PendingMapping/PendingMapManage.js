...
const PendingMapManage = (rowData,dialogClose,showAddPending) => {
...
return (
    ...
    <Alert severity="success" color="info" sx={{width: '96%'}}> Status : Pending </Alert>
             ...
             <Grid container spacing={2}>
              <Grid xs={12} sm={12} item>
                ...
                {/* <Grid xs={12} sm={5} item>               
                   ...
                   <Chip label="Pending" fullWidth   rows={3}/>
...
export default PendingMapManage;